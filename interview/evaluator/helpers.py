...
async def run_evaluations_from_payload(payload: dict, synthetic_transcript: str = None) -> dict:
    """
    ...
    system_prompt = payload.get('interviewer_prompt', f"Evaluate this candidate for the {job_title} position based on their interview responses.")
...
**Interviewer:** Thank you for your time today. We'll be in touch soon."""
    ...
    try:
        ...
        deepseek_result = await call_openrouter_deepseek(system_prompt, rubric, transcript)
