...
# TODO use ..supabase.services.QueueService to retrieve context from the interviewer_queue Supabase table using auth_token (sample valid token for testingff1d3457-2407-4195-b0e3-ee608ecd7e94)
...
async def run_bot(transport: BaseTransport, runner_args: RunnerArguments):
    ...
    auth_token = (
        room_url.split("/")[-1]
        if room_url
        else os.getenv("AUTH_TOKEN", "ff1d3457-2407-4195-b0e3-ee608ecd7e94")
            ...
            try:
                ...
                if transcript_path.exists():
                    with transcript_path.open("r", encoding="utf-8") as f:
                        full_text = f.read()
                    # For transcript_json, we can pass an empty dict or minimal data
...
# TODO when the interview ends use ..supabase.services.TranscriptService to read the interview_id.md file, load it into Supabase table "transcripts" column "full_text" and update status on the "interviews" table to "completed"
