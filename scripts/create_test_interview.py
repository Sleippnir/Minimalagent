...
async def create_test_interview():
    ...
    mock_interview_context = {
        ...
        "job": {"title": "Test Developer", "description": "Test job description."},
        "questions": [{"question_id": "q1", "text": "Tell me about yourself."}],
    ...
    try:
        ...
        result = (
            await client.table("interviewer_queue")
            .insert(mock_interview_context)
            .execute()
        )
